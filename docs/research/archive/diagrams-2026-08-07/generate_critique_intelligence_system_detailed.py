#!/usr/bin/env python3
"""Generate the archived detailed Critique Intelligence System atlas."""
...
OUT = Path(__file__).with_name(
    "critique-intelligence-system-detailed-2026-08-07.pdf"
)
W, H = landscape(A3)
...
def page_traceability(c: canvas.Canvas) -> None:
    ...
    snapshot = [
        ("UNIT", "93 / 93 passing at diagram phase"),
